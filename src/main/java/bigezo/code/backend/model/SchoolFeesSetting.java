...
public class SchoolFeesSetting {
    ...
    @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "schoolFeesSetting", fetch = FetchType.LAZY)
    private List<SchoolFeesDetails> feesDetails = new ArrayList<>();
